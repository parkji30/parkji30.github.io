 ...
 */
export function update_and_render(canvas_id, current_time) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.update_and_render(ptr0, len0, current_time);
    if (ret[1]) {
 ...
 * @param {number} height
 */
export function resize_game(width, height) {
    wasm.resize_game(width, height);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_instanceof_HtmlCanvasElement_3e2e95b109dae976 = function() { return logError(function (arg0) {
        let result;
        try {
    ...
    imports.wbg.__wbg_set_fillStyle_2bb9477555f866ec = function() { return logError(function (arg0, arg1) {
        arg0.fillStyle = arg1;
    }, arguments) };
    ...
    imports.wbg.__wbg_set_strokeStyle_4d716c7d92c95b45 = function() { return logError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('starcraft_site_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
